...
video = cv2.VideoWriter('video.mp4',fourcc,30.0,(width,height))
_ = [video.write(i) for i in images_list]

height, width, layers = masked_image_list[0].shape
fourcc = cv2.VideoWriter_fourcc(*'MP4V')
video = cv2.VideoWriter('masked_video.mp4',fourcc,30.0,(width,height))
_ = [video.write(i) for i in masked_image_list]'''
