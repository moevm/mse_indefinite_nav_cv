...
from lane_detection import get_segments

__all__ = ["LaneFilterHistogram"]


class LaneFilterHistograms:
    ...
    def prepareSegments(self, segments):
        ...
        for segment in segments:
            ...
            # TODO if self.range_est > point_range > self.range_est_min:
...
if __name__ == "__main__":
    ...
    all_segments = get_segments("./20160310230308_morty.video.mp4", True)
    filter = LaneFilterHistograms(
        mean_d_0=0,
        mean_phi_0=0,
        sigma_d_0=0.1,
        sigma_phi_0=0.1,
